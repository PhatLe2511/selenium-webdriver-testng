...
//		CustomDropDownList("span#number-button>span.ui-selectmenu-icon", "ul#number-menu div", "19");
		...
		CustomDropDownList2("span#salutation-button>span.ui-selectmenu-icon", "div.ui-selectmenu-open li", "Dr.", "div.ui-selectmenu-open li.ui-state-disabled");
	...
	public void TC_04_Angular_select() {
		...
		scrollToElement(By.xpath("//ng-select[@bindvalue='provinceCode']/ancestor::div[@class='col-lg-3 col-md-12']"));
		SleepInSecond(2);
...
//		Assert.assertEquals(driver.findElement(By.cssSelector("ng-select[bindvalue='districtCode'] div.ng-star-inserted")).getText(), "Huyện U Minh Thượng");
		...
		scrollToElement(By.xpath("//ng-select[@bindvalue='wardCode']/ancestor::div[@class='col-lg-3 col-md-12']"));
		SleepInSecond(2);
...
//		Assert.assertEquals(driver.findElement(By.cssSelector("ng-select[bindvalue='wardCode'] div.ng-star-inserted")).getText(), "Xã Hoà Chánh");
	...
	public void enterToCustomDropDownList(String parentLocator, String childLocator, String expectedText) {
		...
		for (WebElement item : allNumbers) {
	...
	public void CustomDropDownList_js(String parentLocator, String childLocator, String expectedText) {
//		driver.findElement(By.cssSelector(parentLocator)).click();
		
		jsExecutor.executeScript("arguments[0].click();", driver.findElement(By.cssSelector(parentLocator)));
		
		explicitWait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector(parentLocator)));
		
		List<WebElement> allTexts = driver.findElements(By.cssSelector(childLocator));
		...
		for (WebElement text : allTexts) {
			...
			if (actualText.equals(expectedText)) {
				...
				jsExecutor.executeScript("arguments[0].scrollIntoView(true);", text);
...
//				number.click();
	...
	public void CustomDropDownList2(String parentLocator, String childLocator, String expectedText, String attributeValue)
	{
		driver.findElement(By.cssSelector(parentLocator)).click();
		...
		String attributeD = driver.findElement(By.cssSelector(attributeValue)).getAttribute("aria-disabled");
		Assert.assertEquals(attributeD, "true");
